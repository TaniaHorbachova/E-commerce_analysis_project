...
Загальна виручка (Total Revenue) склала 21.78 млн, що є показником для оцінки масштабу операційної діяльності.
Середня вартість замовлення становить 1277.44. 
...
Категорія Mobile є пріоритетним каналом продажів: через неї проходить понад 12М виручки. Це підкреслює важливість Mobile-First стратегії для утримання клієнтів.
