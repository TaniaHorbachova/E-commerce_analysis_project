...
У межах проєкту були підготовлені дві аналітичні таблиці: **v_cleaned** для дослідження продажів на рівні замовлень та **v_customer_churn** для аналізу поведінки клієнтів. Проведено агрегування ключових метрик у розрізі товарних категорій, міст, статі, типу пристрою та часових трендів доходу. Додатково виконано поведінкову аналітику, що дозволило глибше зрозуміти патерни взаємодії клієнтів із платформою.
